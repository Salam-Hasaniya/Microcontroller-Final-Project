...
void Decrease_Time()
{
            switch (Select_Field)               		// Decrement the proper field
            {
                case 0:
                    ...
                    break;
                case 1:
                    // add code here to handle minute decrement

                case 2:
                    // add code here to handle second decrement

                case 3:
                    // add code here to handle month decrement

                case 4:
                    // add code here to handle day decrement   

                case 5:
                    // add code here to handle year decrement
